...
async function run() {
  const result = await authlete.hardwareSecurityKey.delete({
    serviceId: "<id>",
    handle: "<value>",
  });
...
import { hardwareSecurityKeyDelete } from "authlete/funcs/hardwareSecurityKeyDelete.js";
...
async function run() {
  const res = await hardwareSecurityKeyDelete(authlete, {
    serviceId: "<id>",
    handle: "<value>",
  });
  if (res.ok) {
...
async function run() {
  const result = await authlete.hardwareSecurityKey.get({
    serviceId: "<id>",
    handle: "<value>",
  });
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { hardwareSecurityKeyGet } from "authlete/funcs/hardwareSecurityKeyGet.js";
...
async function run() {
  const res = await hardwareSecurityKeyGet(authlete, {
    serviceId: "<id>",
    handle: "<value>",
  });
  if (res.ok) {
