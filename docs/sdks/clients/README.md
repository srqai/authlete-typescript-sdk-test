...
async function run() {
  const result = await authlete.clients.list({
    serviceId: "<id>",
  });
...
import { clientsList } from "authlete/funcs/clientsList.js";
...
async function run() {
  const res = await clientsList(authlete, {
    serviceId: "<id>",
  });
  if (res.ok) {
...
async function run() {
  const result = await authlete.clients.refreshSecret({
    serviceId: "<id>",
    clientIdentifier: "<value>",
  });
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientsRefreshSecret } from "authlete/funcs/clientsRefreshSecret.js";
...
async function run() {
  const res = await clientsRefreshSecret(authlete, {
    serviceId: "<id>",
    clientIdentifier: "<value>",
  });
  if (res.ok) {
...
async function run() {
  const result = await authlete.clients.getGrantedScopes({
    serviceId: "715948317",
    clientId: "1140735077",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientsGetGrantedScopes } from "authlete/funcs/clientsGetGrantedScopes.js";
...
async function run() {
  const res = await clientsGetGrantedScopes(authlete, {
    serviceId: "715948317",
    clientId: "1140735077",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
...
async function run() {
  const result = await authlete.clients.deleteGrantedScopes({
    serviceId: "<id>",
    clientId: "<id>",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientsDeleteGrantedScopes } from "authlete/funcs/clientsDeleteGrantedScopes.js";
...
async function run() {
  const res = await clientsDeleteGrantedScopes(authlete, {
    serviceId: "<id>",
    clientId: "<id>",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
