...
async function run() {
  const result = await authlete.authorization.ticketUpdate({
    serviceId: "<id>",
...
import { authorizationTicketUpdate } from "authlete/funcs/authorizationTicketUpdate.js";
...
async function run() {
  const res = await authorizationTicketUpdate(authlete, {
    serviceId: "<id>",
    authorizationTicketUpdateRequest: {
      ticket: "<value>",
      info: "<value>",
