# VerifiableCredentialsManagement
...
async function run() {
  const result = await authlete.verifiableCredentials.management.getMetadata({
    serviceId: "<id>",
    vciMetadataRequest: {
      pretty: true,
    },
...
import { verifiableCredentialsManagementGetMetadata } from "authlete/funcs/verifiableCredentialsManagementGetMetadata.js";
...
async function run() {
  const res = await verifiableCredentialsManagementGetMetadata(authlete, {
    serviceId: "<id>",
    vciMetadataRequest: {
      pretty: true,
    },
  ...
  if (res.ok) {
    ...
    console.log("verifiableCredentialsManagementGetMetadata failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.verifiableCredentials.management.getJwtIssuer({
    serviceId: "<id>",
    vciJwtissuerRequest: {
      pretty: true,
    },
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { verifiableCredentialsManagementGetJwtIssuer } from "authlete/funcs/verifiableCredentialsManagementGetJwtIssuer.js";
...
async function run() {
  const res = await verifiableCredentialsManagementGetJwtIssuer(authlete, {
    serviceId: "<id>",
    vciJwtissuerRequest: {
      pretty: true,
    },
  ...
  if (res.ok) {
    ...
    console.log("verifiableCredentialsManagementGetJwtIssuer failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.verifiableCredentials.management.getJwks({
    serviceId: "<id>",
    vciJwksRequest: {
      pretty: false,
    },
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { verifiableCredentialsManagementGetJwks } from "authlete/funcs/verifiableCredentialsManagementGetJwks.js";
...
async function run() {
  const res = await verifiableCredentialsManagementGetJwks(authlete, {
    serviceId: "<id>",
    vciJwksRequest: {
      pretty: false,
    },
  ...
  if (res.ok) {
    ...
    console.log("verifiableCredentialsManagementGetJwks failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.verifiableCredentials.management.batchParse({
    serviceId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { verifiableCredentialsManagementBatchParse } from "authlete/funcs/verifiableCredentialsManagementBatchParse.js";
...
async function run() {
  const res = await verifiableCredentialsManagementBatchParse(authlete, {
    serviceId: "<id>",
    vciBatchParseRequest: {},
  });
  if (res.ok) {
    ...
    console.log("verifiableCredentialsManagementBatchParse failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.verifiableCredentials.management.batchIssue({
    serviceId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { verifiableCredentialsManagementBatchIssue } from "authlete/funcs/verifiableCredentialsManagementBatchIssue.js";
...
async function run() {
  const res = await verifiableCredentialsManagementBatchIssue(authlete, {
    serviceId: "<id>",
    vciBatchIssueRequest: {},
  });
  if (res.ok) {
    ...
    console.log("verifiableCredentialsManagementBatchIssue failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.verifiableCredentials.management.deferredParse({
    serviceId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { verifiableCredentialsManagementDeferredParse } from "authlete/funcs/verifiableCredentialsManagementDeferredParse.js";
...
async function run() {
  const res = await verifiableCredentialsManagementDeferredParse(authlete, {
    serviceId: "<id>",
    vciDeferredParseRequest: {},
  });
  if (res.ok) {
    ...
    console.log("verifiableCredentialsManagementDeferredParse failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.verifiableCredentials.management.deferredIssue({
    serviceId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { verifiableCredentialsManagementDeferredIssue } from "authlete/funcs/verifiableCredentialsManagementDeferredIssue.js";
...
async function run() {
  const res = await verifiableCredentialsManagementDeferredIssue(authlete, {
    serviceId: "<id>",
    vciDeferredIssueRequest: {},
  });
  if (res.ok) {
    ...
    console.log("verifiableCredentialsManagementDeferredIssue failed:", res.error);
  }
}
