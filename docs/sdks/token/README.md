...
import { tokenProcess } from "authlete/funcs/tokenProcess.js";
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { tokenFail } from "authlete/funcs/tokenFail.js";
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { tokenIssue } from "authlete/funcs/tokenIssue.js";
...
async function run() {
  const result = await authlete.token.reissueIdToken({
    serviceId: "<id>",
  });
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { tokenReissueIdToken } from "authlete/funcs/tokenReissueIdToken.js";
...
async function run() {
  const res = await tokenReissueIdToken(authlete, {
    serviceId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("tokenReissueIdToken failed:", res.error);
  }
}
