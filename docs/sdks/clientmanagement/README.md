...
async function run() {
  const result = await authleteTest.clientManagement.getClient({
    serviceId: "<id>",
    clientId: "<id>",
  });
...
import { clientManagementGetClient } from "authlete-test/funcs/clientManagementGetClient.js";
...
async function run() {
  const res = await clientManagementGetClient(authleteTest, {
    serviceId: "<id>",
    clientId: "<id>",
  });
  if (res.ok) {
...
async function run() {
  await authleteTest.clientManagement.deleteClient({
    serviceId: "<id>",
    clientId: "<id>",
  });
...
```typescript
import { AuthleteTestCore } from "authlete-test/core.js";
import { clientManagementDeleteClient } from "authlete-test/funcs/clientManagementDeleteClient.js";
...
async function run() {
  const res = await clientManagementDeleteClient(authleteTest, {
    serviceId: "<id>",
    clientId: "<id>",
  });
  if (res.ok) {
...
async function run() {
  const result = await authleteTest.clientManagement.updateSecret({
    serviceId: "<id>",
...
```typescript
import { AuthleteTestCore } from "authlete-test/core.js";
import { clientManagementUpdateSecret } from "authlete-test/funcs/clientManagementUpdateSecret.js";
...
async function run() {
  const res = await clientManagementUpdateSecret(authleteTest, {
    serviceId: "<id>",
    clientIdentifier: "<value>",
    clientSecretUpdateRequest: {
      clientSecret: "my_updated_client_secret",
...
async function run() {
  const result = await authleteTest.clientManagement.listAuthorizedApplications({
    serviceId: "<id>",
...
```typescript
import { AuthleteTestCore } from "authlete-test/core.js";
import { clientManagementListAuthorizedApplications } from "authlete-test/funcs/clientManagementListAuthorizedApplications.js";
...
async function run() {
  const res = await clientManagementListAuthorizedApplications(authleteTest, {
    serviceId: "<id>",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
  });
...
async function run() {
  const result = await authleteTest.clientManagement.updateAuthorization({
    serviceId: "<id>",
    clientId: "<id>",
...
```typescript
import { AuthleteTestCore } from "authlete-test/core.js";
import { clientManagementUpdateAuthorization } from "authlete-test/funcs/clientManagementUpdateAuthorization.js";
...
async function run() {
  const res = await clientManagementUpdateAuthorization(authleteTest, {
    serviceId: "<id>",
    clientId: "<id>",
    clientAuthorizationUpdateRequest: {
      subject: "john",
...
async function run() {
  const result = await authleteTest.clientManagement.deleteAuthorizations({
    serviceId: "<id>",
    clientId: "<id>",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
...
```typescript
import { AuthleteTestCore } from "authlete-test/core.js";
import { clientManagementDeleteAuthorizations } from "authlete-test/funcs/clientManagementDeleteAuthorizations.js";
...
async function run() {
  const res = await clientManagementDeleteAuthorizations(authleteTest, {
    serviceId: "<id>",
    clientId: "<id>",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
...
async function run() {
  const result = await authleteTest.clientManagement.getRequestableScopes({
    serviceId: "<id>",
    clientId: "<id>",
  });
...
```typescript
import { AuthleteTestCore } from "authlete-test/core.js";
import { clientManagementGetRequestableScopes } from "authlete-test/funcs/clientManagementGetRequestableScopes.js";
...
async function run() {
  const res = await clientManagementGetRequestableScopes(authleteTest, {
    serviceId: "<id>",
    clientId: "<id>",
  });
  if (res.ok) {
...
async function run() {
  await authleteTest.clientManagement.deleteRequestableScopes({
    serviceId: "<id>",
    clientId: "<id>",
  });
...
```typescript
import { AuthleteTestCore } from "authlete-test/core.js";
import { clientManagementDeleteRequestableScopes } from "authlete-test/funcs/clientManagementDeleteRequestableScopes.js";
...
async function run() {
  const res = await clientManagementDeleteRequestableScopes(authleteTest, {
    serviceId: "<id>",
    clientId: "<id>",
  });
  if (res.ok) {
