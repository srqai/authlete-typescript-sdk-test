...
* [issueBatch](#issuebatch) - Issue Batch Credentials
* [parseDeferred](#parsedeferred) - Parse Deferred Credential
* [issueDeferred](#issuedeferred) - Issue Deferred Credential
...
async function run() {
  const result = await authlete.verifiableCredentialIssuers.getJwks({
    serviceId: "<id>",
    vciJwksRequest: {
      pretty: false,
    },
...
import { verifiableCredentialIssuersGetJwks } from "authlete/funcs/verifiableCredentialIssuersGetJwks.js";
...
async function run() {
  const res = await verifiableCredentialIssuersGetJwks(authlete, {
    serviceId: "<id>",
    vciJwksRequest: {
      pretty: false,
    },
  ...
  if (res.ok) {
    ...
    console.log("verifiableCredentialIssuersGetJwks failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.verifiableCredentialIssuers.createOffer({
    serviceId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { verifiableCredentialIssuersCreateOffer } from "authlete/funcs/verifiableCredentialIssuersCreateOffer.js";
...
async function run() {
  const res = await verifiableCredentialIssuersCreateOffer(authlete, {
    serviceId: "<id>",
    vciOfferCreateRequest: {},
  });
  if (res.ok) {
    ...
    console.log("verifiableCredentialIssuersCreateOffer failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.verifiableCredentialIssuers.issueBatch({
    serviceId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { verifiableCredentialIssuersIssueBatch } from "authlete/funcs/verifiableCredentialIssuersIssueBatch.js";
...
async function run() {
  const res = await verifiableCredentialIssuersIssueBatch(authlete, {
    serviceId: "<id>",
    vciBatchIssueRequest: {},
  });
  if (res.ok) {
    ...
    console.log("verifiableCredentialIssuersIssueBatch failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.verifiableCredentialIssuers.parseDeferred({
    serviceId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { verifiableCredentialIssuersParseDeferred } from "authlete/funcs/verifiableCredentialIssuersParseDeferred.js";
...
async function run() {
  const res = await verifiableCredentialIssuersParseDeferred(authlete, {
    serviceId: "<id>",
    vciDeferredParseRequest: {},
  });
  if (res.ok) {
    ...
    console.log("verifiableCredentialIssuersParseDeferred failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.verifiableCredentialIssuers.issueDeferred({
    serviceId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { verifiableCredentialIssuersIssueDeferred } from "authlete/funcs/verifiableCredentialIssuersIssueDeferred.js";
...
async function run() {
  const res = await verifiableCredentialIssuersIssueDeferred(authlete, {
    serviceId: "<id>",
    vciDeferredIssueRequest: {},
  });
  if (res.ok) {
    ...
    console.log("verifiableCredentialIssuersIssueDeferred failed:", res.error);
  }
}
