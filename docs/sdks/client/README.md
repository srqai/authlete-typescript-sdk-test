...
async function run() {
  const result = await authlete.client.updateLockFlag({
    serviceId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientUpdateLockFlag } from "authlete/funcs/clientUpdateLockFlag.js";
...
async function run() {
  const res = await clientUpdateLockFlag(authlete, {
    serviceId: "<id>",
    clientIdentifier: "<value>",
    clientFlagUpdateRequest: {
      clientLocked: true,
  ...
  if (res.ok) {
    ...
    console.log("clientUpdateLockFlag failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.client.refreshSecret({
    serviceId: "<id>",
    clientIdentifier: "<value>",
  });
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientRefreshSecret } from "authlete/funcs/clientRefreshSecret.js";
...
async function run() {
  const res = await clientRefreshSecret(authlete, {
    serviceId: "<id>",
    clientIdentifier: "<value>",
  });
  if (res.ok) {
    ...
    console.log("clientRefreshSecret failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.client.updateSecret({
    serviceId: "<id>",
    clientIdentifier: "<value>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientUpdateSecret } from "authlete/funcs/clientUpdateSecret.js";
...
async function run() {
  const res = await clientUpdateSecret(authlete, {
    serviceId: "<id>",
    clientIdentifier: "<value>",
    clientSecretUpdateRequest: {
      clientSecret: "my_updated_client_secret",
  ...
  if (res.ok) {
    ...
    console.log("clientUpdateSecret failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.client.listAuthorizations({
    serviceId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientListAuthorizations } from "authlete/funcs/clientListAuthorizations.js";
...
async function run() {
  const res = await clientListAuthorizations(authlete, {
    serviceId: "<id>",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
  });
  if (res.ok) {
    ...
    console.log("clientListAuthorizations failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.client.updateAuthorizations({
    serviceId: "<id>",
    clientId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientUpdateAuthorizations } from "authlete/funcs/clientUpdateAuthorizations.js";
...
async function run() {
  const res = await clientUpdateAuthorizations(authlete, {
    serviceId: "<id>",
    clientId: "<id>",
    clientAuthorizationUpdateRequest: {
      subject: "john",
  ...
  if (res.ok) {
    ...
    console.log("clientUpdateAuthorizations failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.client.deleteAuthorizations({
    serviceId: "<id>",
    clientId: "<id>",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientDeleteAuthorizations } from "authlete/funcs/clientDeleteAuthorizations.js";
...
async function run() {
  const res = await clientDeleteAuthorizations(authlete, {
    serviceId: "<id>",
    clientId: "<id>",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("clientDeleteAuthorizations failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.client.getGrantedScopes({
    serviceId: "715948317",
    clientId: "1140735077",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientGetGrantedScopes } from "authlete/funcs/clientGetGrantedScopes.js";
...
async function run() {
  const res = await clientGetGrantedScopes(authlete, {
    serviceId: "715948317",
    clientId: "1140735077",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("clientGetGrantedScopes failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.client.deleteGrantedScopes({
    serviceId: "<id>",
    clientId: "<id>",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientDeleteGrantedScopes } from "authlete/funcs/clientDeleteGrantedScopes.js";
...
async function run() {
  const res = await clientDeleteGrantedScopes(authlete, {
    serviceId: "<id>",
    clientId: "<id>",
    subjectPathParameter: "<value>",
    subjectQueryParameter: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("clientDeleteGrantedScopes failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.client.getRequestableScopes({
    serviceId: "<id>",
    clientId: "<id>",
  });
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientGetRequestableScopes } from "authlete/funcs/clientGetRequestableScopes.js";
...
async function run() {
  const res = await clientGetRequestableScopes(authlete, {
    serviceId: "<id>",
    clientId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("clientGetRequestableScopes failed:", res.error);
  }
}
...
async function run() {
  const result = await authlete.client.updateRequestableScopes({
    serviceId: "<id>",
    clientId: "<id>",
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientUpdateRequestableScopes } from "authlete/funcs/clientUpdateRequestableScopes.js";
...
async function run() {
  const res = await clientUpdateRequestableScopes(authlete, {
    serviceId: "<id>",
    clientId: "<id>",
    clientExtensionRequestableScopesUpdateRequest: {},
  });
  if (res.ok) {
    ...
    console.log("clientUpdateRequestableScopes failed:", res.error);
  }
}
...
async function run() {
  await authlete.client.deleteRequestableScopes({
    serviceId: "<id>",
    clientId: "<id>",
  });
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { clientDeleteRequestableScopes } from "authlete/funcs/clientDeleteRequestableScopes.js";
...
async function run() {
  const res = await clientDeleteRequestableScopes(authlete, {
    serviceId: "<id>",
    clientId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("clientDeleteRequestableScopes failed:", res.error);
  }
}
