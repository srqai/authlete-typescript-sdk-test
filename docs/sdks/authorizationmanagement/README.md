...
async function run() {
  const result = await authlete.authorization.management.getTicketInfo({
    serviceId: "<id>",
...
import { authorizationManagementGetTicketInfo } from "@big76/test-sdk/funcs/authorizationManagementGetTicketInfo.js";
...
async function run() {
  const res = await authorizationManagementGetTicketInfo(authlete, {
    serviceId: "<id>",
    authorizationTicketInfoRequest: {
      ticket: "<value>",
    },
  ...
  if (res.ok) {
    ...
    console.log("authorizationManagementGetTicketInfo failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.AuthorizationTicketInfoPostApiRequest](../../models/operations/authorizationticketinfopostapirequest.md)                                                           | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
```typescript
import { AuthleteCore } from "@big76/test-sdk/core.js";
import { authorizationManagementUpdateTicket } from "@big76/test-sdk/funcs/authorizationManagementUpdateTicket.js";
...
async function run() {
  const res = await authorizationManagementUpdateTicket(authlete, {
    serviceId: "<id>",
    authorizationTicketUpdateRequest: {
      ticket: "<value>",
      info: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("authorizationManagementUpdateTicket failed:", res.error);
  }
}
