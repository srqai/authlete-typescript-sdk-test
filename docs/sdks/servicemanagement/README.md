...
async function run() {
  const result = await authlete.serviceManagement.listServices();
...
import { serviceManagementListServices } from "authlete/funcs/serviceManagementListServices.js";
...
async function run() {
  const res = await serviceManagementListServices(authlete);
  if (res.ok) {
...
async function run() {
  const result = await authlete.serviceManagement.create({
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { serviceManagementCreate } from "authlete/funcs/serviceManagementCreate.js";
...
async function run() {
  const res = await serviceManagementCreate(authlete, {
    serviceName: "My service",
    issuer: "https://my-service.example.com",
    clientIdAliasEnabled: true,
    supportedGrantTypes: [
...
async function run() {
  const result = await authlete.serviceManagement.getServiceConfiguration({
    serviceId: "<id>",
  });
...
```typescript
import { AuthleteCore } from "authlete/core.js";
import { serviceManagementGetServiceConfiguration } from "authlete/funcs/serviceManagementGetServiceConfiguration.js";
...
async function run() {
  const res = await serviceManagementGetServiceConfiguration(authlete, {
    serviceId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
