 ...
 */
export function verifiableCredentialsGetOfferInfo(
  client: AuthleteCore,
  request: operations.VciOfferInfoApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.VciOfferInfoResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  const body = encodeJSON("body", payload.vci_offer_info_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VciOfferInfoResponse$inboundSchema),
