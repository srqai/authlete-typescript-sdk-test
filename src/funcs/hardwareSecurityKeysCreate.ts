 ...
 * Create Security Key
 */
export function hardwareSecurityKeysCreate(
  client: AuthleteTestCore,
  request: operations.HskCreateApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.HskCreateResponse,
    | errors.ResultError
    | AuthleteTestError
...
> {
  ...
  const body = encodeJSON("body", payload.hsk_create_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.HskCreateResponse$inboundSchema),
