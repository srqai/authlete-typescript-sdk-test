 ...
 * token.
 */
export function tokenManagementReissueIdToken(
  client: AuthleteCore,
  request: operations.IdtokenReissueApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.IdtokenReissueResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  const body = encodeJSON("body", payload.idtoken_reissue_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.IdtokenReissueResponse$inboundSchema),
