 ...
 */
export function clientManagementUpdateLockFlag(
  client: AuthleteCore,
  request: operations.ClientFlagUpdateApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ClientFlagUpdateResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  const body = encodeJSON("body", payload.client_flag_update_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ClientFlagUpdateResponse$inboundSchema),
