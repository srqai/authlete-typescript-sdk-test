 ...
 */
export function clientManagementUpdateRequestableScopes(
  client: AuthleteCore,
  request: operations.ClientExtensionRequestablesScopesUpdateApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ClientExtensionRequestableScopesUpdateResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  >(
    M.json(
      200,
      models.ClientExtensionRequestableScopesUpdateResponse$inboundSchema,
    ),
