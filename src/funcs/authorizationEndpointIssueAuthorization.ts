 ...
 * </details>
 */
export function authorizationEndpointIssueAuthorization(
  client: AuthleteTestCore,
  request: operations.AuthAuthorizationIssueApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.AuthorizationIssueResponse,
    | errors.ResultError
    | AuthleteTestError
...
> {
  ...
  const body = encodeJSON("body", payload.authorization_issue_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AuthorizationIssueResponse$inboundSchema),
