 ...
 */
export function pushedAuthorizationEndpointCreate(
  client: AuthleteTestCore,
  request: operations.PushedAuthReqApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.PushedAuthorizationResponse,
    | errors.ResultError
    | AuthleteTestError
...
> {
  ...
  const body = encodeJSON("body", payload.pushed_authorization_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PushedAuthorizationResponse$inboundSchema),
