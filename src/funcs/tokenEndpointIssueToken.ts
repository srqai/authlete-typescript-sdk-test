 ...
 * </details>
 */
export function tokenEndpointIssueToken(
  client: AuthleteCore,
  request: operations.AuthTokenIssueApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.TokenIssueResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  const body = encodeJSON("body", payload.token_issue_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TokenIssueResponse$inboundSchema),
