 ...
 */
export function tokenOperationsAuthTokenCreateBatchStatusApi(
  client: AuthleteCore,
  request: operations.AuthTokenCreateBatchStatusApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.TokenCreateBatchStatusResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AuthTokenCreateBatchStatusApiRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    ...
    tokenBatchRequestId: encodeSimple(
      "tokenBatchRequestId",
      payload.tokenBatchRequestId,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TokenCreateBatchStatusResponse$inboundSchema),
