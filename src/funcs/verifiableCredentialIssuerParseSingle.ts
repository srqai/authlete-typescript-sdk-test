 ...
 */
export function verifiableCredentialIssuerParseSingle(
  client: AuthleteCore,
  request: operations.VciSingleParseApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.VciSingleParseResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  const body = encodeJSON("body", payload.vci_single_parse_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VciSingleParseResponse$inboundSchema),
