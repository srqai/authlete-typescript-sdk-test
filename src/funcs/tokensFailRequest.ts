 ...
 * ```
 */
export function tokensFailRequest(
  client: AuthleteCore,
  request: operations.AuthTokenFailApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.TokenFailResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  const body = encodeJSON("body", payload.token_fail_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TokenFailResponse$inboundSchema),
