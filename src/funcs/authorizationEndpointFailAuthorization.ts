 ...
 * </details>
 */
export function authorizationEndpointFailAuthorization(
  client: AuthleteTestCore,
  request: operations.AuthAuthorizationFailApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.AuthorizationFailResponse,
    | errors.ResultError
    | AuthleteTestError
...
> {
  ...
  const body = encodeJSON("body", payload.authorization_fail_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AuthorizationFailResponse$inboundSchema),
