 ...
 */
export function verifiableCredentialIssuersIssueDeferred(
  client: AuthleteCore,
  request: operations.VciDeferredIssueApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.VciDeferredIssueResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  const body = encodeJSON("body", payload.vci_deferred_issue_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VciDeferredIssueResponse$inboundSchema),
