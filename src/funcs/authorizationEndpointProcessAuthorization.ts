 ...
 * </details>
 */
export function authorizationEndpointProcessAuthorization(
  client: AuthleteCore,
...
> {
  ...
  const body = encodeJSON("body", payload.authorization_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AuthorizationResponse$inboundSchema),
