 ...
 */
export function clientManagementUpdateAuthorizations(
  client: AuthleteCore,
  request: operations.ClientAuthorizationUpdateApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ClientAuthorizationUpdateResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  const body = encodeJSON("body", payload.client_authorization_update_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ClientAuthorizationUpdateResponse$inboundSchema),
