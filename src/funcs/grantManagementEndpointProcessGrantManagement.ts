 ...
 */
export function grantManagementEndpointProcessGrantManagement(
  client: AuthleteCore,
...
> {
  ...
  const body = encodeJSON("body", payload.g_m_request, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GMResponse$inboundSchema),
