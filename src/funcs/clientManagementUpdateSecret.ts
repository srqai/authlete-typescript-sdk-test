 ...
 * API.
 */
export function clientManagementUpdateSecret(
  client: AuthleteTestCore,
  request: operations.ClientSecretUpdateApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ClientSecretUpdateResponse,
    | errors.ResultError
    | AuthleteTestError
...
> {
  ...
  const body = encodeJSON("body", payload.client_secret_update_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ClientSecretUpdateResponse$inboundSchema),
