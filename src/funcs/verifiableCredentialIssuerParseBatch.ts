 ...
 */
export function verifiableCredentialIssuerParseBatch(
  client: AuthleteCore,
  request: operations.VciBatchParseApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.VciBatchParseResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  const body = encodeJSON("body", payload.vci_batch_parse_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VciBatchParseResponse$inboundSchema),
