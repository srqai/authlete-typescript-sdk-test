 ...
 */
export function verifiableCredentialIssuersCreateOffer(
  client: AuthleteCore,
  request: operations.VciOfferCreateApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.VciOfferCreateResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  const body = encodeJSON("body", payload.vci_offer_create_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VciOfferCreateResponse$inboundSchema),
