 ...
 */
export function clientManagementGetRequestableScopes(
  client: AuthleteCore,
  request: operations.ClientExtensionRequestablesScopesGetApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ClientExtensionRequestableScopesGetResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  >(
    M.json(
      200,
      models.ClientExtensionRequestableScopesGetResponse$inboundSchema,
    ),
