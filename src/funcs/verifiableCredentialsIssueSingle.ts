 ...
 */
export function verifiableCredentialsIssueSingle(
  client: AuthleteCore,
  request: operations.VciSingleIssueApiRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.VciSingleIssueResponse,
    | errors.ResultError
    | AuthleteError
...
> {
  ...
  const body = encodeJSON("body", payload.vci_single_issue_request, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.VciSingleIssueResponse$inboundSchema),
