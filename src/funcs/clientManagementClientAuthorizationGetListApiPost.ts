 ...
 */
export function clientManagementClientAuthorizationGetListApiPost(
  client: AuthleteCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ClientAuthorizationGetListApiPostRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.client_authorization_get_list_request,
    { explode: true },
  );
