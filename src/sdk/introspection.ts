...
import { IntrospectionManagement } from "./introspectionmanagement.js";

export class Introspection extends ClientSDK {
  private _management?: IntrospectionManagement;
  get management(): IntrospectionManagement {
    return (this._management ??= new IntrospectionManagement(this._options));
  }
