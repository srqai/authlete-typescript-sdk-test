...
import { deviceFlowProcessAuthorization } from "../funcs/deviceFlowProcessAuthorization.js";
import { deviceFlowProcessVerification } from "../funcs/deviceFlowProcessVerification.js";
...
export class DeviceFlow extends ClientSDK {
  ...
  async processAuthorization(
    ...
    return unwrapAsync(deviceFlowProcessAuthorization(
      this,
      request,
      options,
    ));
  ...
  async processVerification(
    ...
    return unwrapAsync(deviceFlowProcessVerification(
      this,
      request,
      options,
    ));
