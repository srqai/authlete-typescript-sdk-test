...
import { deviceFlowAuthorize } from "../funcs/deviceFlowAuthorize.js";
import { deviceFlowComplete } from "../funcs/deviceFlowComplete.js";
import { deviceFlowVerify } from "../funcs/deviceFlowVerify.js";
...
export class DeviceFlow extends ClientSDK {
  ...
  async authorize(
    ...
    return unwrapAsync(deviceFlowAuthorize(
      this,
      request,
      options,
    ));
  ...
  async verify(
    ...
    return unwrapAsync(deviceFlowVerify(
      this,
      request,
      options,
    ));
