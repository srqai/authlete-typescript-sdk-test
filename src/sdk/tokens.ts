...
import { tokensFailRequest } from "../funcs/tokensFailRequest.js";
import { tokensIssue } from "../funcs/tokensIssue.js";
import { tokensRequest } from "../funcs/tokensRequest.js";
...
export class Tokens extends ClientSDK {
  ...
  async request(
    ...
    return unwrapAsync(tokensRequest(
      this,
      request,
      options,
    ));
  ...
  async failRequest(
    ...
    return unwrapAsync(tokensFailRequest(
      this,
      request,
      options,
    ));
