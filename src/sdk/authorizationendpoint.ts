...
import { authorizationEndpointGetAuthorizationTicketInfo } from "../funcs/authorizationEndpointGetAuthorizationTicketInfo.js";
import { authorizationEndpointUpdateAuthorizationTicket } from "../funcs/authorizationEndpointUpdateAuthorizationTicket.js";
...
export class AuthorizationEndpoint extends ClientSDK {
   ...
   */
  async getAuthorizationTicketInfo(
    request: operations.GetAuthorizationTicketInfoRequest,
    options?: RequestOptions,
  ): Promise<models.AuthorizationTicketInfoResponse> {
    return unwrapAsync(authorizationEndpointGetAuthorizationTicketInfo(
      this,
      request,
      options,
    ));
