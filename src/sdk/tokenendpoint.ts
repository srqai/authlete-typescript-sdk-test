...
import { tokenEndpointIssueToken } from "../funcs/tokenEndpointIssueToken.js";
import { tokenEndpointProcessToken } from "../funcs/tokenEndpointProcessToken.js";
...
export class TokenEndpoint extends ClientSDK {
  ...
  async processToken(
    ...
    return unwrapAsync(tokenEndpointProcessToken(
      this,
      request,
      options,
    ));
  ...
  async issueToken(
    ...
    return unwrapAsync(tokenEndpointIssueToken(
      this,
      request,
      options,
    ));
