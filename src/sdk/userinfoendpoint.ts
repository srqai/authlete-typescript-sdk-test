...
import { userInfoEndpointIssue } from "../funcs/userInfoEndpointIssue.js";
import { userInfoEndpointProcess } from "../funcs/userInfoEndpointProcess.js";
...
export class UserInfoEndpoint extends ClientSDK {
  ...
  async process(
    ...
    return unwrapAsync(userInfoEndpointProcess(
      this,
      request,
      options,
    ));
  ...
  async issue(
    ...
    return unwrapAsync(userInfoEndpointIssue(
      this,
      request,
      options,
    ));
