...
import { federationEndpointProcessRegistration } from "../funcs/federationEndpointProcessRegistration.js";
...
export class FederationEndpoint extends ClientSDK {
  ...
  async processRegistration(
    ...
    return unwrapAsync(federationEndpointProcessRegistration(
      this,
      request,
      options,
    ));
