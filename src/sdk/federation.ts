...
import { federationProcessConfiguration } from "../funcs/federationProcessConfiguration.js";
import { federationProcessRegistration } from "../funcs/federationProcessRegistration.js";
import { ClientSDK, RequestOptions } from "../lib/sdks.js";
import * as models from "../models/index.js";
import * as operations from "../models/operations/index.js";
import { unwrapAsync } from "../types/fp.js";

export class Federation extends ClientSDK {
  /**
  ...
  async processConfiguration(
    ...
    return unwrapAsync(federationProcessConfiguration(
      this,
      request,
      options,
    ));
  ...
  async processRegistration(
    ...
    return unwrapAsync(federationProcessRegistration(
      this,
      request,
      options,
    ));
