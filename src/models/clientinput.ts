...
import {
  ...
  ClientResponseModesItems$outboundSchema,
} from "./clientresponsemodesitems.js";
import {
  ClientType,
...
export type ClientInput = {
   ...
   */
  responseModes?: Array<ClientResponseModesItems> | undefined;
  /**
...
> = z.object({
  ...
  responseModes: z.array(ClientResponseModesItems$inboundSchema).optional(),
...
> = z.object({
  ...
  responseModes: z.array(ClientResponseModesItems$outboundSchema).optional(),
  credentialResponseEncryptionRequired: z.boolean().optional(),
  mtlsEndpointAliasesUsed: z.boolean().optional(),
});
